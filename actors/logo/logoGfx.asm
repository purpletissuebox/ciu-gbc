...
.gfx_tasks:
	GFXTASK tissue_tiles1, $0000, bkg_tiles0, $0000
	GFXTASK tissue_tiles2, $0000, bkg_tiles0, $0600
	GFXTASK tissue_tiles3, $0000, bkg_tiles1, $0000
	GFXTASK tissue_map, $0000, bkg_map, $0000
	GFXTASK tissue_attr, $0000, bkg_attr, $0000
	.end
